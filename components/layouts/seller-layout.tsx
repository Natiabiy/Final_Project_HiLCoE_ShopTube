...
import { Bell, Home, LogOut, Package, Settings, ShoppingBag, ShoppingCart, Users } from "lucide-react"
...
export function SellerLayout({ children }: { children: ReactNode }) {
  ...
  const routes = [
    ...
    },
    {
      ...
      label: "Orders",
      icon: ShoppingCart,
      active: pathname === "/seller/orders",
    },
    {
      href: "/seller/subscribers",
      label: "Subscribers",
      icon: Users,
      active: pathname === "/seller/subscribers",
    },
    {
    ...
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-background px-6">
        <Link href="/" className="flex items-center gap-2 font-semibold">
          ...
          <span className="hidden md:inline-block">ShopTube Seller</span>
        </Link>
